	...
	return(
		...
		<div className="flex justify-between mt-2 ">
		  ...
		  <div className="flex gap-2">
		  		...
		  		<div onClick={handleEnd} className={` cursor-pointer rounded-full w-8 h-8 flex justify-center item-center ` + (data >= 124 ? "bg-gray-100":"bg-gray-200")}>
		  		<FaArrowRight className={` text-xl mt-1 `+ (data >= 124 ? "text-gray-200":"text-gray-800")}/></div>
		  </div>
		</div>
		<hr/>
